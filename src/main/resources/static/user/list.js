$(document).ready(function () {
    selectMenu("oneMenu-id|userMenu-id");
    ...
    var table = $('#dynamic-table').DataTable({
        ...
        columns: [
            ...
            {"data": "professional", "defaultContent": ""},
            {"data": "classRoom", "defaultContent": ""},
            {"data": "createTimeStr", "defaultContent": ""},
            {"data": "modifyTimeStr", "defaultContent": ""},
    ...
    $.ajax({
        ...
        success: function (res) {
            if (res.code == 1) {
                ...
                $("#inputProfessional").val(data.professional);
                $("#inputClassRoom").val(data.classRoom);
...
function view(userCode) {
    $('#modal-default').load("/user/detail", {userCode: userCode}).modal();
}
